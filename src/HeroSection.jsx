      ...
      <div className="relative h-[600px] w-full">
        ...
        <div className="absolute flex flex-col text-justify justify-center px-14 space-y-4">
          ...
          <p className="text-gray-200 text-lg max-w-xl">
            Follow the exciting adventure of Aladdin, a young street thief who discovers a magical lamp and a powerful Genie.
          </p>
          <div className="flex space-x-4 mt-8">
            ...
            <button className="flex bg-white text-black px-6 py-3 rounded-full bg-blur-lg hover:bg-gray-200 transition-all">
